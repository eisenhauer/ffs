...
the highest-level FFS construct is the \routine{IOFile}.  FFS files are always
...
these situations, FFS provides an abstraction called an \routine{IOContext}.
...
Internally to FFS, \routine{IOFile} and \routine{IOContext} are the same data structure.
...
basics of FFS in the context of \routine{IOFile}s.  The \routine{IOContext} functionality
